...
const Navbar = () => {
  ...
  return (
    <motion.div
      ...
      className="relative z-20 mx-6 mt-6 rounded-2xl bg-linear-to-r from-black/80 via-black/80 to-black/90 backdrop-blur-2xl border border-white/10 shadow-[0_22px_55px_rgba(0,0,0,0.75)] flex items-center justify-between px-8 py-4"
    >
            ...
            {showCredits && (
              ...
              >
                ...
                <button
                  ...
                  className="w-full py-2 rounded-lg bg-linear-to-r from-white to-gray-200 text-black font-semibold hover:opacity-90"
                >
                  Buy More Credits
                </button>
              </motion.div>
