...
const TopicForm = ({ setResult, setLoading, loading, setError }) => {
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl bg-linear-to-r from-black/90 via-black/80 to-black/90 backdrop-blur-2xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.75)]
      ...
      <motion.button
        ...
        className={`w-full mt-4 py-3 rounded-xl font-semibold flex items-center justify-center gap-3 transition ${
          loading
            ...
            : "bg-linear-to-r from-white to-gray-200 text-black shadow-[0_15px_35px_rgba(0,0,0,0.4)]"
        }`}
      >
