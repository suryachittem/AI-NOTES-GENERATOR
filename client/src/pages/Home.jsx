...
const Home = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white textbalck">
      <Navbar />
      {/* TOP */}
        ...
        <div>
          ...
          >
            <motion.h1
              ...
              className="text-5xl lg:text-6xl font-extrabold leading-tight bg-linear-to-r from-black/90 via-black/60 to-black/90 bg-clip-text text-transparent"
            >
          ...
          <motion.button
            ...
            className="mt-10 px-10 py-3 rounded-xl flex items-center gap-3 bg-linear-to-r from-black/90 via-black/80 to-black/90 border border-white/90 text-white font-semibold text-lg shadow-[0_25px_60px_rgba(0,0,0,0.7)]"
          >
            Get Started
          </motion.button>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-8 py-32 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <Feature
          icon="📂"
          title="Project Notes"
          des="Well-strcutured content for assignments and projects."
        />
        <Feature
          icon="📊"
          title="Diagrams"
...
function Feature({ icon, title, des }) {
  return (
    <motion.div
      ...
      transition={{ type: "spring", stiffness: 200, damping: 18 }}
      className="relative rounded-2xl p-6 bg-linear-to-r from-black/90 via-black/80 to-black/90 backdrop-blur-2xl border border-white/10 shadow-[0_30px_80px_rgba(0,0,0,0.7)] text-white"
      style={{
