    ...
    <div className="min-h-screen overflow-hidden bg-white text-black px-8">
      ...
      <main className="max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <p className="mt-6 max-w-xl text-lg bg-linear-to-r from-gray-700 via-gray-500/80 to-gray-700 bg-clip-text text-transparent">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          <Feature
            ...
            des="Start with 50 Free credits to generate notes without paying."
          />
          <Feature
            icon="📘"
            title="Exam Notes"
