...
function Notes() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-r from-gray-100 to-gray-200 px-6 py-8">
      <motion.header
      ...
      {!result && (
        <motion.div
          ...
          className="h-64 rounded-2xl flex flex-col items-center justify-center backdrop-blur-lg border border-dashed border-gray-300 text-gray-500 shadow-inner"
        >
      ...
      {result && (
        ...
        >
          ...
          <div
            className="lg:col-span-3 rounded-2xl bg-white shadow-[0_15px_40px_rgba(0,0,0,0.15)]
          p-6"
          >
